 ...
 *
 */
if ( ! class_exists( 'CHAT_WHATSAPP_Walker_Nav_Menu_Edit' ) && class_exists( 'Walker_Nav_Menu_Edit' ) ) {
  class CHAT_WHATSAPP_Walker_Nav_Menu_Edit extends Walker_Nav_Menu_Edit {
