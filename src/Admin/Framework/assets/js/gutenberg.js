...
( function( blocks, blockEditor, element, components ) {
  ...
  if ( !window.CHAT_WHATSAPP_gutenberg_blocks ) { return; }

  Object.values(window.CHAT_WHATSAPP_gutenberg_blocks).forEach( function( block ) {
    ...
    registerBlockType(block.name, {
      ...
      edit: function (props) {
        return (
          createElement('div', {className: 'chat-whatsapp-shortcode-block'},

            createElement(Button, {
              'data-modal-id': block.modal_id,
              'data-gutenberg-id': block.name,
              className: 'is-secondary chat-whatsapp-shortcode-button',
              onClick: function () {
                window.CHAT_WHATSAPP_gutenberg_props = props;
              },
            }, block.button_title ),
