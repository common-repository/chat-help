...
(function($) {
  ...
  function CHAT_WHATSAPPAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  CHAT_WHATSAPPAjaxChosen.prototype.init = function() {
  ...
  CHAT_WHATSAPPAjaxChosen.prototype.events = function() {
  ...
  CHAT_WHATSAPPAjaxChosen.prototype.search_field_focused = function() {
  ...
  CHAT_WHATSAPPAjaxChosen.prototype.search_welcome_message = function() {
  ...
  CHAT_WHATSAPPAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('chat-whatsapp-chosen', _this.options.data).done( function( response ) {
  ...
  CHAT_WHATSAPPAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.chat-whatsapp-hide-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.CHAT_WHATSAPPChosenOrder($hidden_value, true);
  ...
  $.fn.CHAT_WHATSAPPAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new CHAT_WHATSAPPAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, CHAT_WHATSAPPAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  CHAT_WHATSAPPAbstractChosenOrder = (function() {

    function CHAT_WHATSAPPAbstractChosenOrder() {}

    CHAT_WHATSAPPAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    CHAT_WHATSAPPAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    CHAT_WHATSAPPAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    CHAT_WHATSAPPAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    CHAT_WHATSAPPAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    CHAT_WHATSAPPAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    CHAT_WHATSAPPAbstractChosenOrder.CHAT_WHATSAPPChosenOrder = function(select, order, force) {
    ...
    return CHAT_WHATSAPPAbstractChosenOrder;
  ...
  $.fn.extend({
    CHAT_WHATSAPPChosenOrder: function(order, force) {
      return _CHAT_WHATSAPPChosenOrder.CHAT_WHATSAPPChosenOrder(this, order, force);
    }
  });

  this._CHAT_WHATSAPPChosenOrder = (function(_super) {
    __extends(_CHAT_WHATSAPPChosenOrder, _super);

    function _CHAT_WHATSAPPChosenOrder() {
      _ref = _CHAT_WHATSAPPChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _CHAT_WHATSAPPChosenOrder.relAttributeName = 'data-option-array-index';

    _CHAT_WHATSAPPChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _CHAT_WHATSAPPChosenOrder.getDOMElement = function(element) {
    ...
    _CHAT_WHATSAPPChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _CHAT_WHATSAPPChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _CHAT_WHATSAPPChosenOrder;

  })(CHAT_WHATSAPPAbstractChosenOrder);
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('chat-whatsapp-depend-on');
        });
        ...
        $(controls).each(function() {
          $(this).addClass('chat-whatsapp-depend-on');
        });
...
(function(root, factory) {
  ...
  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectCHAT_WHATSAPP = FormSerializer.serializeObject;
    $.fn.serializeJSONCHAT_WHATSAPP   = FormSerializer.serializeJSON;
  }
