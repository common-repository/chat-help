 ...
 * @subpackage chat-whatsapp/src/Admin/Views/ChatWhatsappOptions
 * @author     ThemeAtelier<themeatelierbd@gmail.com>
 */

namespace ThemeAtelier\ChatWhatsapp\Admin\Views;

use ThemeAtelier\ChatWhatsapp\Admin\Views\ChatWhatsappPopup;
use ThemeAtelier\ChatWhatsapp\Admin\Views\ChatWhatsappButton;
use ThemeAtelier\ChatWhatsapp\Admin\Views\ChatWhatsappShortcode;
use ThemeAtelier\ChatWhatsapp\Admin\Views\ChatWhatsappCustomCode;
use ThemeAtelier\ChatWhatsapp\Admin\Views\ChatWhatsappBackup;
use ThemeAtelier\ChatWhatsapp\Admin\Framework\Classes\CHAT_WHATSAPP;

class ChatWhatsappOptions {
	...
	public static function options( $prefix ) {
		...
		CHAT_WHATSAPP::createOptions(
			$prefix,
			array(
				'menu_title'              => esc_html__( 'Whatsapp Chat', 'chat-help' ),
				'menu_slug'               => 'chat-help',
				'menu_type'               => 'submenu',
				'show_bar_menu'           => false,
				'show_sub_menu'           => false,
				'framework_title'         => esc_html__( 'Whatsapp Chat', 'chat-help' ),
		...
		ChatWhatsappPopup::options( $prefix, $timezones );
		ChatWhatsappButton::options( $prefix );
		ChatWhatsappShortcode::options( $prefix );
		ChatWhatsappCustomCode::options( $prefix );
		ChatWhatsappBackup::options( $prefix );
	}
}
